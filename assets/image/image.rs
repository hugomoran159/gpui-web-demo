...
fn main() {
    ...
    app.run(move |cx: &mut App| {
        ...
        #[cfg(target_arch = "wasm32")]
        let local_resource: SharedUri = "http://localhost:8080/assets/image/app-icon.png".into();

        #[cfg(not(target_arch = "wasm32"))]
        let asset_resource: SharedString = "image/color.svg".into();
        #[cfg(target_arch = "wasm32")]
        let asset_resource: SharedUri = "http://localhost:8080/assets/image/color.svg".into();
